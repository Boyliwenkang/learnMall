...
public class OssServiceImpl implements OssService {
    ...
    @Value(value = "${aliyun.oss.policy.expire}")
    private int ALIYUN_OSS_EXPIRE;

    @Value(value = "${aliyun.oss.maxSize}")
    private int ALIYUN_OSS_MAX_SIZE;

    @Value(value = "${aliyun.oss.callback}")
    ...
    @Value(value = "${aliyun.oss.dir.prefix}")
    ...
    public OssPolicyResult policy() {
        ...
        String dir = String.format(ALIYUN_OSS_DIR_PREFIX + simpleDateFormat, new Date());
        // 签名有效期
